...
import { Avatar, Box, Card, CardContent, Grid, Paper, Typography, Button } from '@mui/material';
...
return data;
    ...
    let columns = [
        ...
        { field: 'completedFollowUps', headerName: ' Completed Follow Ups',headerClassName: 'main-heading',  flex: 1 },
        {
            ...
            renderCell: (params) => (
                <Button variant="contained" style={{ background: '#19cfcc'}} onClick={() => { handleView(params.row) }}>View</Button>
            )
